...
virtual environment on each and runs the four commands against a copy of this
repository's map, and installs the plugin from the checkout with the Claude
